...
import Select from '@/RegionSelects'
...
describe('v-region Select 表单元素下拉列表模式', function () {
  ...
  describe('功能操作', () => {
    ...
    it('省级列表中选中 “河北省”，选择元素显示的文本应为 “河北省”', async () => {
      await o.findAll('.rg-select').at(0).trigger('click')
      await o.findAll('.rg-select__list').at(0).findAll('li').at(3).trigger('click')
    ...
    it('城市列表中选中 “唐山市”，选择元素显示的文本应为 “唐山市”', async () => {
      await o.findAll('.rg-select').at(1).trigger('click')
      await o.findAll('.rg-select__list').at(1).findAll('li').at(2).trigger('click')
    ...
    it('区/县列表中选中 “路南区”，选择元素显示的文本应为 “路南区”', async () => {
      await o.findAll('.rg-select').at(2).trigger('click')
      await o.findAll('.rg-select__list').at(2).findAll('li').at(1).trigger('click')
    ...
    it('乡/镇/街道列表中选中 “友谊街道”，选择元素显示的文本应为 “友谊街道”', async () => {
      await o.findAll('.rg-select').at(3).trigger('click')
      await o.findAll('.rg-select__list').at(3).findAll('li').at(2).trigger('click')
    ...
    it('省级修改为 “北京市”，选择元素显示的文本应当变更为 “北京市”', async () => {
      await o.findAll('.rg-select').at(0).trigger('click')
      await o.findAll('.rg-select__list').at(0).findAll('li').at(1).trigger('click')
